...
namespace Proyecto_Eventos_Progra_V.Models
{
    ...
    public partial class BD_Proyecto_EventosEntities : DbContext
    {
        public BD_Proyecto_EventosEntities()
            : base("name=BD_Proyecto_EventosEntities")
        {
        }
        ...
        public virtual ObjectResult<spConfirmacionLogin_Result> spConfirmacionLogin(string pUsuario, string pClave)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spConfirmacionLogin_Result>("spConfirmacionLogin", pUsuarioParameter, pClaveParameter);
        }
    }
}
